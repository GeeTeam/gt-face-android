...
import com.geetest.oneperson.image.SilentImageInfo;
import com.geetest.oneperson.impl.BaseCardListener;
import com.geetest.slientimageverification.widget.MediaUtils;
import com.geetest.slientimageverification.widget.SendView;
import com.geetest.slientimageverification.widget.VideoProgressBar;
                    ...
                    public void run() {
                        ...
                        try {
                            ...
                            if (passed) {
                                ...
                                onSilentIdNumberSuccess(new SilentImageInfo(true, liveness_score, verification_score));
                            } else {
                                onSilentIdNumberSuccess(new SilentImageInfo(false, 0.0f, 0.0f));
                            }
...
//        view = (TextView) findViewById(R.id.view);
    ...
    public void onSilentIdNumberSuccess(SilentImageInfo silentImageInfo) {
        if (silentImageInfo != null) {
            Intent intent = new Intent();

            intent.putExtra(LIVENESS_SCORE, silentImageInfo.getLiveness_score());
            intent.putExtra(PASSED, silentImageInfo.isPassed());
            intent.putExtra(VERIFICATION_SCORE, silentImageInfo.getVerification_score());
    ...
    private View.OnClickListener selectClick = new View.OnClickListener() {
        ...
        public void onClick(View v) {
            ...
            cardApi.inputSilentImageVerification(path, getIntent().getStringExtra(UploadActivity.IMAEG_PATH));
