...
@Route(path = "/slientverification/activity")
public class MainActivity extends AppCompatActivity {
    private TextView mTipsView;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_main_slient_verification);
        mTipsView = (TextView) findViewById(R.id.txt_tips);
        ((TextView) findViewById(R.id.txt_app_name)).setText(
                getString(R.string.app_name_with_client_slient_verification, CardApi.getVersion()));
